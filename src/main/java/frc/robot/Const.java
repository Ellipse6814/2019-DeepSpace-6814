...
public class Const {
    ...
    public static final double kBallIntakeSpd = 1.0;
    ...
    public static final double[] kDrivePowerGears = { 0.2, 0.5, 0.7 };
    public static final double[] kDriveTurnGears = { 0.2, 0.2, 0.2 };
