...
// /**
// * Summary: this class is designed to access a very powerful logging system
// very
// * easily. This class is a singleton. It takes the sender, message,
// messageLevel
// * from anyone and logs it through two ways: (sysout print line && saving log
// to
// * log.csv). CSV writer flushing is done automatically every 0.5 seconds using
// * the wpi notifier.
// *
...
// /**
// * writer.println(data); puts the data into the printWriter buffer, which
// means
// * the data is not saved in the file. Use flush to apply buffer to file.
// */
// private void logData(String data) {
