...
public class Field {
    ...
    public static final Point kCargoSupplyLeft = in2m(new Point());
    public static final Point kCargoSupplyRight = in2m(new Point());
    ...
    public static final Point kvCargoSupplyLeft = in2m(new Point());
    public static final Point kvCargoSupplyRight = in2m(new Point());
