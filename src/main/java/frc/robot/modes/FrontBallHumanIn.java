...
public class FrontBallHumanIn extends Mode {
    ...
    protected void prepInit() {
        ...
        prepCmd = new SetRobot(ArmState.FrontBallHumanIn, JawState.BallHuman, BallState.In, HatchState.Grab);
        prepCmd.start();
    }
    ...
    protected void execInit() {
        ...
        execCmd = new SetRobot(ArmState.FrontBallHumanIn, JawState.BallHuman, BallState.Hold, HatchState.Grab);
        execCmd.start();
    }
